    ...
    <div class="container-fluid">
        ...
        <div class="row align-items-center py-3 px-xl-5">
            ...
            <%List<WishList> list1  = WishListDao.getWishListByCusId(c.getId()); %>
                <a href="customer-wishlist.jsp" class="btn border">
                    <i class="fas fa-heart text-primary"></i>
                    <span class="badge"><%=list1.size() %></span>
                </a>
                ...
                <div class="card product-item border-0 mb-4">
                    ...
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        ...
                        <div class="d-flex justify-content-center">
                            <h6>Rs. <%=p.getPprice() %></h6><h6 class="text-muted ml-2"></h6>
                        </div>
                    </div>
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        ...
                        <a href="removefromwishlist.jsp?wid=<%=w.getWid()%>" class="btn btn-sm text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>Remove From WishList</a>
                    </div>
                </div>
            </div>
           <%} %>
