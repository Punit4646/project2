                         ...
                         <div class="nav-item dropdown">
                           <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown"><%=c.getName() %></a>
                                <div class="dropdown-menu rounded-0 m-0">
                                    ...
                                    <a href="customer-Changepassword.jsp" class="dropdown-item">Change Password</a>
    ...
    <div class="container-fluid py-5">
		...
		<%Product p = ProductDao.getProductByPid(id); %>
            ...
            <div class="col-lg-7 pb-5">
                ...
                <h3 class="font-weight-semi-bold mb-4">Rs. <%=p.getPprice() %></h3>
                <p class="mb-4"><%=p.getPdesc() %></p>
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    ...
                    <button class="btn btn-primary px-3" name="action" value="addtocart" ><i class="fa fa-shopping-cart mr-1"></i> Add To Cart</button>
                    </form>
					...
					<%if(flag == false){ %>
                     ...
                     <input type="hidden" name="pid" value="<%=p.getPid()%>">
						<input type="hidden" name="cusid" value="<%=c.getId()%>">
                    <button class="btn btn-primary px-3" name="action" value="addtowishlist"><i class="fa fa-shopping-cart mr-1"></i> Add Wishlist</button>
                    </form>
                    <%} %>
                </div>
